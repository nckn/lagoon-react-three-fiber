...
export default function Experience({
  ...
  const toggleControlsFromChild = (val) => {
      ...
      >
        ...
        <group position={[-0, -1, 0]}>
          ...
          <Synth
            ...
            toggleControls={(val) => toggleControlsFromChild(val) }
            // keyPressed={keyPressed} 
            url={'/lagoon-3D-synth-2.2.4.glb'} position={[0, 1, 0]} rotation={[0, 0, 0]} hasCollider={false} scale={1}
          />
